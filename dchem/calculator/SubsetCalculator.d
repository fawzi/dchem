...
class FullSysNeighLooper:SymmNeighLooper{
    ...
    void loopOnNeighWithinT(V)(ParticleSys!(V)pSys,DynPVector!(V,XType)neigh,V epsilon,
        int delegate(ref DynPVector!(V,XType))loopBody)
    {
        ...
        fullLooper.loopOnNeighWithin(fullPSys,fullNeigh,epsilon,delegate int(ref DynPVector!(V,XType)fullN){
